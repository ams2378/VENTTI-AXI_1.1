...
while(1){
       printf("SLAVE DEVICE: slave device created\n");
       get_port->get (m_req);
       cout<< "SLAVE DEVICE: received vci_request @: "<< sc_time_stamp()<< "with addr" << m_req.address <<endl;
...
void slave_device::send_rsp(bool bErr)
{
